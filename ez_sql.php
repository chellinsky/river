<?php
	...
	define("EZSQL_DB_USER", $USERNAME);			// <-- mysql db user
	define("EZSQL_DB_PASSWORD", $PASSWORD);		// <-- mysql db password
	define("EZSQL_DB_NAME", $DATABASE);		// <-- mysql db pname
	define("EZSQL_DB_HOST", $SERVER);	// <-- mysql server host
